  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-brand-dark px-6 py-12 transition-colors duration-500">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-20">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-brand-accent/20 blur-[120px] rounded-full" />
      </div>
      ...
      >
        <div className="text-center space-y-4 mb-10">
          ...
          <h1 className="text-4xl font-black text-brand-dark dark:text-white">Welcome Back</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center px-2">
              <label className="text-sm font-bold text-neutral-500 uppercase tracking-widest">Password</label>
              <Link to="/reset-password" name="reset-password-link" className="text-sm font-bold text-brand-green hover:underline">Forgot?</Link>
            </div>
            <div className="relative">
              <input 
        ...
        <div className="mt-8 text-center">
          <p className="text-neutral-500 dark:text-neutral-400 font-medium">
            Don't have an account? <Link to="/register" name="signup-link" className="text-brand-green font-bold hover:underline">Sign Up</Link>
          </p>
        </div>
      </motion.div>
    </div>
